...
<WelcomeScreen>
    ...
    MDRectangleFlatButton:
        ...
        on_release:
            app.about_us_func()
            root.manager.current = 'aboutusscreen'
...
class TextApp(MDApp):
    ...
    def grammar_func(self):
        self.root.get_screen("grammarscreen").ids.grammar.text = str(self.show_data_grammar())
    ...
    def correct_func(self):
        self.root.get_screen("correctscreen").ids.correct.text = str(self.show_data_correct())

    def clear_func(self, **args):
        self.root.get_screen("functionscreen").ids['text_field'].text = ""

    def translate_to_hindi_func(self):
        self.root.get_screen("translatescreen").ids.translate.text = str(self.show_data_to_hindi())

    def show_data_to_hindi(self):
        a = ""
        try:
            searchword = str(self.root.get_screen("functionscreen").ids.text_field.text)
    ...
    def translate_to_marathi_func(self):
        self.root.get_screen("translatescreen").ids.translate.text = str(self.show_data_to_marathi())
    ...
    def translate_to_english_func(self):
        self.root.get_screen("translatescreen").ids.translate.text = str(self.show_data_to_english())
    ...
    def show_about_us(self):
        a = """This application was developed by a group of students from Pune Institute of Computer Technology as a project for their first year project based learning.
        This project was guided by Prof. A.A. Chavan.
    ...
    def about_us_func(self):
        self.root.get_screen("aboutusscreen").ids.about_us.text = str(self.show_about_us())
